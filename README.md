...
A hardware + software buzzer system for practicing [National Science Bowl]([https://science.energy.gov/wdts/nsb/](https://science.osti.gov/wdts/nsb)), built with ESP32 microcontrollers and a Node.js WebSocket server. Features a polished web frontend with a live scoreboard, match timer, question timer, and full event log.
